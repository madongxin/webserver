...
constexpr const char *kErrMapLineFull = "ERR_MAP_LINE_FULL";
constexpr const char *kErrMapNoLine = "ERR_MAP_NO_LINE";
constexpr const char *kErrMapLineLimit = "ERR_MAP_LINE_LIMIT";
constexpr const char *kErrMapNotReady = "ERR_MAP_NOT_READY";
constexpr const char *kErrMapDraining = "ERR_MAP_DRAINING";
constexpr const char *kErrQueueNeeded = "ERR_QUEUE_NEEDED";
constexpr const char *kErrQueueInvalid = "ERR_QUEUE_INVALID";
constexpr const char *kErrQueueNotReady = "ERR_QUEUE_NOT_READY";
constexpr const char *kErrDungeonCreateForbidden = "ERR_DUNGEON_CREATE_FORBIDDEN";
constexpr const char *kErrDungeonNotFound = "ERR_DUNGEON_NOT_FOUND";
constexpr const char *kErrDungeonNotMember = "ERR_DUNGEON_NOT_MEMBER";
constexpr const char *kErrPortalUnknown = "ERR_PORTAL_UNKNOWN";
constexpr const char *kErrPortalTooFar = "ERR_PORTAL_TOO_FAR";
